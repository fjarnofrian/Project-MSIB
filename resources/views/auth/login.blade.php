          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              ...
              <form method="POST" action="{{ route('login') }}">
                  ...
                  <div class="pt-1 mb-4">
                    <button id='btnLogin' class="btn btn-dark btn-lg btn-block" type="submit">{{ __('Login') }}</button>
                  </div>

                  <a id='container-APLogin' class="small text-muted" href="#">Forgot password?</a>
                  <p id='container-APLogin' class="mb-5 pb-lg-2">Don't have an account? <a class="" href="{{ route('register') }}">{{ __('Register Here') }}</a></p>
